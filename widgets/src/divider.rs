...
pub enum DividerIndent {
  ...
  #[default]
  None,
  /// Indents the divider with equal padding on the leading sides.
  Start,
  /// Indents the divider with equal padding on the trailing sides.
  End,
  /// Indents the divider with equal padding on the both sides.
  Both,
}
