...
mod tests {
  ...
  fn new_line_bounds() {
    ...
    assert_eq!(visual.visual_rect().size, Size::new(26.72168, 28.));
  }
  ...
  fn cluster_position() {
    ...
    assert!((0, 31) == glyphs.position_by_cluster(22));
    assert!((0, 25) == glyphs.position_by_cluster(31));
    assert!((0, 6) == glyphs.position_by_cluster(53));
  }
