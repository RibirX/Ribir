...
When `@` is followed directly by a type, it invokes the corresponding builder to construct the object. This builder is typically generated by the `#[declare]` macro, which enables the use of built-in attributes. We will explore this mechanism in detail in the [Built-in Attributes & FatObj](./built_in_attributes_and_fat_obj.md) section.
