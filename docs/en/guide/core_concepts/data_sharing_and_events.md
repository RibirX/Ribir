...
For `Variant<Color>`, there are built-in methods for Material Design theming:
...
These methods automatically adjust the lightness while preserving reactivity, making it easy to create consistent, theme-aware UIs.
