...
/// specific custom event by [`on_custom_event`], or register a handler to
/// [`RawCustomEvent`] and downcast it to the specific type as you want by
/// [`on_raw_custom_event`].
  ...
  fn custom_event() {
    ...
    let w = fn_widget! {
      @MockBox {
        ...
        on_raw_custom_event: move |e: &mut RawCustomEvent| {
        ...
        @MockBox {
          ...
          on_custom_event: move |e: &mut MyCustomEvent| {
