...
- **core**: Field declaration methods must now start with `with_` prefix (#pr by @M-Adoo)
...
<!-- next-url -->
[@Unreleased]: https://github.com/RibirX/Ribir/compare/ribir-v0.4.0-alpha.39...HEAD
